...
public class HandDraggable : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    ...
    // Variable that stores the hand position the card currently is in
    public int handPos;
    ...
    {
        // When beginning a drag, sets its opacity to half and does not allow the game object block raycasting
